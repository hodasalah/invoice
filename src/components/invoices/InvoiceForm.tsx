...
const InvoiceForm = ({ editData, onSave, clients = [], onClose }: InvoiceFormProps) => {
	...
	useEffect(() => {
		if (editData) {
			...
			setOriginalData(editData);
				...
				console.log('client invoice:', data);
	...
	return (
		<div className='bg-white  rounded-xl shadow-lg w-full max-w-2xl p-1   '>
			<div className='max-h-[90vh] overflow-y-auto p-6'>
				...
				<textarea
					...
					value={
						...
						`${data.clientAddress.street} ${data.clientAddress.city} ${data.clientAddress.state} ${data.clientAddress.zip} ${data.clientAddress.country}`
					}
					readOnly
				/>
